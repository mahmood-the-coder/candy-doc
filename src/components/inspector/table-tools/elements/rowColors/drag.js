...
export function initRowColorsDrag(container) {
  ...
  window.addEventListener("mouseup", () => {
    ...
    if(!selected)return;
    [...container.querySelectorAll(".candyDoc__inspectorTableRowTextColorItem")].forEach((item,i)=>item.dataset.index=i.toString())
    const colors=[...container.querySelectorAll(".candyDoc__inspectorTableRowTextColorItem")].map(i=>i.dataset.row_textColor);
