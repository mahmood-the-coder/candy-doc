...
export function initColColorsDrag(container) {
  ...
  window.addEventListener("mouseup", () => {
    ...
    if(!selected)return;
    [...container.querySelectorAll(".candyDoc__inspectorTableColTextColorItem")].forEach((item,index)=>item.dataset.index=index.toString())
    const colors=[...container.querySelectorAll(".candyDoc__inspectorTableColTextColorItem")].map(i=>i.dataset.row_textColor);
