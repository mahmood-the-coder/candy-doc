...
export function initRowBackgroundColorsDrag(container) {
  ...
  window.addEventListener("mouseup", () => {
    ...
    if(!selected)return;
    [...container.querySelectorAll(".candyDoc__inspectorTableRowColorItem")].forEach((item,index)=>item.dataset.index=index.toString())
    const colors=[...container.querySelectorAll(".candyDoc__inspectorTableRowColorItem")].map(i=>i.dataset.row_backgroundColor);
