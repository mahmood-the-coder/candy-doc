...
import { pagesArrayWrapper } from "./pagesTools.js";
import {chapterFontWrapper} from "./chaptersFont.js"
import { pagesFontWrapper } from "./PagesFont.js";

export const wrapper = document.createElement("div");
wrapper.classList.add("candyDoc__inspectorToolsWrapper");
wrapper.append(label,pagesFontWrapper,chapterFontWrapper,pagesArrayWrapper);
