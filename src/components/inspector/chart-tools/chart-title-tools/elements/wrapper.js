import { titleAlign } from "./align.js";
import { titleColor } from "./color.js";
import { titleFontSize } from "./fontSize.js";
import { titleFontWeight } from "./fontWeight.js";
import { label } from "./label.js";
import { titleText } from "./text.js";

export const wrapper = document.createElement("div");
wrapper.classList.add("candyDoc__inspectorToolsWrapper");
wrapper.append(label,titleText,titleColor,titleAlign,titleFontSize,titleFontWeight);
