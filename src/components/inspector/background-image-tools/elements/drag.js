...
export function initDrag(container) {
  ...
  container.addEventListener("mousedown", (e) => {
    if (e.target.classList.contains("candyDoc__inspectorBackgroundItemDrag")) {
  ...
  window.addEventListener("mousemove", (e) => {
    ...
    swap(
      ...
      target,
      [
        ...container.querySelectorAll(".candyDoc__inspectorBackgroundItem"),
  ...
  window.addEventListener("mouseup", () => {
    ...
    target = null;
    clone.remove();
   setBackgroundImageArray( [...container.querySelectorAll(".candyDoc__inspectorBackgroundItem")].map(
    (c) => {
      return c.querySelector(".preview").style.backgroundImage;
    }
  ))
