...
pageTitle.classList.add("candyDoc__runningFooterPageTitle","candyDoc__runningFooterTool");
...
pageTitle.addEventListener("mousedown", () => {
  ...
  pageTitleBox.classList.add("candyDoc__runningFooterBox","candyDoc__runningFooterPageTitleTextBox")
