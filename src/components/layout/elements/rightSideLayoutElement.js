export const rightSideLayoutElement = document.createElement("div");
rightSideLayoutElement.classList.add("candyDoc__rightSideLayoutElement");
const toggle = document.createElement("div");
toggle.classList.add("candyDoc__sidebarToggle", "rightToggle","candyDoc__icon");
...
`
rightSideLayoutElement.append(toggle)


toggle.addEventListener("mousedown",(e)=>{
   
    const right=getComputedStyle(e.target.parentElement).right
    if(right=="0px")
    {
        e.target.parentElement.style.right="-251px"
