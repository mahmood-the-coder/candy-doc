...
chapterTitle.classList.add("candyDoc__runningHeaderChapterTitle","candyDoc__runningHeaderTool");
...
chapterTitle.addEventListener("mousedown", () => {
  ...
  chapterTitleBox.classList.add("candyDoc__runningHeaderBox","candyDoc__runningHeaderChapterTitleTextBox","target")
